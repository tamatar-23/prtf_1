  ...
  return (
    <header className="fixed top-6 left-0 right-0 z-50 flex justify-center pointer-events-none px-4">
      <motion.nav
        ...
        className="pointer-events-auto bg-background/80 backdrop-blur-md border border-border/50 shadow-soft-lg rounded-md px-6 py-3 flex items-center justify-between gap-6 md:gap-12 w-full max-w-5xl"
      >
